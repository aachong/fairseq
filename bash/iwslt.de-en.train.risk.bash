...
# 
CUDA_VISIBLE_DEVICES=5,7 python train.py $DATABIN_DIR \
    --lr 0.00005 --clip-norm 0.05 --dropout 0.2 --max-tokens 800 \
...
# CUDA_VISIBLE_DEVICES=6 fairseq-train $DATABIN_DIR \
