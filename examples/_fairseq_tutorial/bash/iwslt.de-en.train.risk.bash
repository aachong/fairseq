...
MKL_THREADING_LAYER=GNU CUDA_VISIBLE_DEVICES=6,7 python train.py $DATABIN_DIR \
    --lr 0.0001 --min-lr 1e-09 --clip-norm 0.1 \
    --dropout 0.3 --max-tokens 3000 \
    --arch fconv_iwslt_de_en --save-dir $SAVE_DIR \
    --reset-optimizer \
    --criterion label_smoothed_cross_entropy_r3f --optimizer adam
#30.98
