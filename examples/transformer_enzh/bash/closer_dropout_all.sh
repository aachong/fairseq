...
###nohup examples/transformer_enzh/bash/closer_dropout_all.sh >> examples/transformer_enzh/test/closer_all1.out 2>&1 &
...
save_dir=$base_dir/checkpoints/closer_all1
